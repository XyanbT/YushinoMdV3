...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
 ...
 let ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, surface: 1, message: `${command} ${type}`, orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
  let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;XdyanBotz⸙;;;\nFN:XdyanBotz⸙\nORG:XdyanBotz⸙\nTITLE:\nitem1.TEL;waid=6285766454089:+62 857-6645-4089\nitem1.X-ABLabel:XdyanBotz⸙\nX-WA-BIZ-DESCRIPTION:${htjava} Tᴀᴋ ᴍᴇɴᴇʀɪᴍᴀ sᴀᴠᴇ ᴋᴏɴᴛᴀᴋ!!\nX-WA-BIZ-NAME:XdyanBotz⸙\nEND:VCARD`
//------- NOMOR
...
let teksbio = `┆⫹⫺ 💌 Nama : Tri Zulfi Ardiansyah
...
{title: "⸙ Biodata XdyanBotz", rowId: ".owner bio"},
{title: "⸙ Biodata Dyan", rowId: ".owner bio2"},
